...
<script type="text/javascript">
	function validate() {
		...
		if (checkValueError("_articlePageID", 9, "addERROR",
				"提交失败: 文章编号不能为空,不能超过9个字符.")) {
			return false;
		}
		if (!isNum("_articlePageID", 1, 9)) {
			setValue("addERROR", "提交失败: 文章编号必须是1-9位的数字.");
			document.getElementById("_articlePageID").focus();
			return false;
		}
		if (checkValueError("_title", 100, "addERROR",
				"提交失败: 文章标题不能为空,不能超过100个字符.")) {
			return false;
		}
		...
		if (checkValueError("_readCount", 9, "addERROR",
				"提交失败: 阅读量不能为空,不能超过9个字符.")) {
			return false;
		}
		if (checkValueError("_likeCount", 9, "addERROR",
...
<body style="margin: 5px;">
	...
	<div class="easyui-panel" title="添加文章" style="width: auto">
		<div style="padding: 10px 20px 10px 20px">
			<s:form id="addform" action="article_add" method="post">
				<table cellpadding="1" class="table table-bordered">
					...
					<tr>
						<td></td>
						<td><p>
								<font size="4" color="blue">文章编号必须从最大的开始递增,不能随意指定.</font>
							</p></td>
					</tr>
					<tr>
						<td>文章编号:</td>
						<td><s:textfield id="_articlePageID"
								name="article._articlePageID" class="comments" /></td>
					</tr>
					<tr>
						<td>文章标题:</td>
						<td><s:textfield id="_title" name="article._title"
								class="comments" /></td>
					</tr>
					<tr>
						<td>作&nbsp;&nbsp;者:</td>
						<td><s:textfield id="_author" name="article._author"
								class="comments" /></td>
					</tr>
					<tr>
						<td>日&nbsp;&nbsp;期:</td>
						<td><s:textfield id="_date" name="article._date"
								class="comments" /></td>
					</tr>
					<tr>
						<td>阅读量:</td>
						<td><s:textfield id="_readCount" name="article._readCount"
								class="comments" readonly="true" value="0" /></td>
					</tr>
					<tr>
						<td>点赞量:</td>
						<td><s:textfield id="_likeCount" name="article._likeCount"
								class="comments" readonly="true" value="0" /></td>
					</tr>

					<tr>
						<td>作者介绍:</td>
						<td><s:textarea id="_authorIntro" name="article._authorIntro"
								class="comments" rows="4" /></td>
					</tr>
					<tr>
						<td>文章内容:</td>
						<td><s:textarea id="_text" name="article._text"
								class="comments" rows="20" /></td>
					</tr>
					<tr>
						<td><a href="javascript:submitForm()"
							class="easyui-linkbutton">提交</a></td>
						<td><a href="article_addUI.action" class="easyui-linkbutton">重置</a></td>
					</tr>
				</table>
			</s:form>
		</div>
