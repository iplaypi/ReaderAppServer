...
<script type="text/javascript">
	function validate() {
		...
		if (checkValueError("_id", 9, "editERROR", "提交失败: 文章主键id不能为空,不能超过9个字符.")) {
			return false;
		}
		if (checkValueError("_articlePageID", 9, "editERROR",
...
<body style="margin: 5px;">
	...
	<div class="easyui-panel" title="编辑文章" style="width: auto">
		<div style="padding: 10px 20px 10px 20px">
			<s:form id="editform" action="article_edit" method="post">
				<table cellpadding="1" class="table table-bordered">
					<!-- hidden隐藏主键_id,更新的时候传回后台用到 -->
					<s:hidden id="_id" name="article._id"></s:hidden>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td><s:textfield id="_articlePageID"
								name="article._articlePageID" class="comments" readonly="true" /></td>
					</tr>
					<tr>
						<td>文章标题:</td>
					...
					<tr>
						...
						<td><a href="article_list.action" class="easyui-linkbutton">返回</a></td>
					</tr>
				</table>
			</s:form>
		</div>
