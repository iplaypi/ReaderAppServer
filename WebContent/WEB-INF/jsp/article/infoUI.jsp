	...
	<div class="easyui-panel" title="更多信息" style="width: auto">
		<div style="padding: 10px 20px 10px 20px">
			<table cellpadding="1" class="table table-bordered">
				<tr>
					<td>文章编号:</td>
					<td><s:textfield name="article._articlePageID"
							class="comments" readonly="true" /></td>
				</tr>
				<tr>
					<td>文章标题:</td>
					<td><s:textfield name="article._title" class="comments"
							readonly="true" /></td>
				</tr>
				<tr>
					<td>作&nbsp;&nbsp;者:</td>
					<td><s:textfield name="article._author" class="comments"
							readonly="true" /></td>
				</tr>
				<tr>
					<td>日&nbsp;&nbsp;期:</td>
					<td><s:textfield name="article._date" class="comments"
							readonly="true" /></td>
				</tr>
				<tr>
					<td>阅读量:</td>
					<td><s:textfield name="article._readCount" class="comments"
							readonly="true" /></td>
				</tr>
				<tr>
					<td>点赞量:</td>
					<td><s:textfield name="article._likeCount" class="comments"
							readonly="true" /></td>
				</tr>
				<tr>
					<td>作者介绍:</td>
					<td><s:textarea name="article._authorIntro" class="comments"
							readonly="true" rows="4" /></td>
				</tr>
				<tr>
					<td>文章内容:</td>
					<td><s:textarea name="article._text" class="comments"
