...
<body style="margin: 5px;">
	<div class="easyui-panel" title="图片列表" style="width: auto">
		<div style="padding: 10px 20px 10px 20px">
			<table cellpadding="1" class="table table-bordered">
				<caption>
					<s:a style="float: left;" href="picture_list.action">
						<font size="4">刷新</font>
				...
				<tbody>
					...
					<s:iterator value="#list">
						<tr>
							<td><s:property value="_picturePageID" /></td>
							...
							<td><s:a action="picture_editUI?_id=%{_id}">编辑</s:a></td>
							<td><s:a action="picture_delete?_id=%{_id}"
									onclick="return confirm('确认删除吗?')">删除</s:a></td>
							<td><s:a action="picture_infoUI?_id=%{_id}">更多信息</s:a></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
