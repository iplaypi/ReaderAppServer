		...
		<div style="padding: 10px 20px 10px 20px">
			<table cellpadding="2" class="table table-bordered">
				...
				<tbody>
					<tr>
						<td>用户名:</td>
						<td><s:textfield name="userinfo._username" class="comments"
								readonly="true" /></td>
					</tr>
					<tr>
						<td>密码(MD5加密):</td>
						<td><s:textfield name="userinfo._password" class="comments"
								readonly="true" /></td>
					</tr>
					<tr>
						<td>用户介绍:</td>
						<td><s:textarea name="userinfo._info" class="comments"
								readonly="true" rows="6" /></td>
					</tr>
				</tbody>
			</table>
		</div>
