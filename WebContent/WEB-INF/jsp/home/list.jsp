...
<body style="margin: 5px;">
	...
	<div class="easyui-panel" title="首页列表" style="width: 1400px">
		<div style="padding: 10px 20px 10px 20px">
			<table cellpadding="1" class="table table-bordered">
				<caption>
					<a style="float: left;" href="home_list.action"><font size="4">刷新</font><img
						id="title" src="<%=basePath%>images/refresh.png" width=24
						height=24 border="0" align="middle" /></a>
				</caption>
				<thead>
					<tr>
						<th>编号</th>
				...
				<tbody>
					...
					<s:iterator value="#list">
						<tr>
							<td><s:property value="_homePageID" /></td>
							<td><s:property value="_title" /></td>
							<td><s:property value="_author" /></td>
							<td><s:property value="_date" /></td>
							<td><s:property value="_imageSrc" /></td>
							<td><s:property value="_readCount" /></td>
							<td><s:property value="_likeCount" /></td>
							<td><s:property value="_musicTitle" /></td>
							<td><s:property value="_musicAuthor" /></td>
							<td><s:property value="_musicImage" /></td>
							<td><s:property value="_musicURL" /></td>

							<!-- 编辑需要主键,不是pageID,注意区分 -->
							<td><s:a action="home_editUI?_id=%{_id}">编辑</s:a></td>
							<td><s:a action="home_delete?_id=%{_id}"
									onclick="return confirm('确认删除吗?')">删除</s:a></td>
							<td><s:a action="home_infoUI?_id=%{_id}">更多信息</s:a></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
